...
namespace Lanche.DynamicWebApi.Controller.Dynamic.Builders
{
    ...
    {
        private static readonly Regex BizNameRegex = new Regex(@"^([a-zA-Z_][a-zA-Z0-9_]*)(\/([a-zA-Z_][a-zA-Z0-9_]*))+$");
        private static readonly Regex BizNameWithActionRegex = new Regex(@"^([a-zA-Z_][a-zA-Z0-9_]*)(\/([a-zA-Z_][a-zA-Z0-9_]*)){2,}$");

        public static bool IsValidServiceName(string serviceName)
        {
            return BizNameRegex.IsMatch(serviceName);
        }

        public static bool IsValidServiceNameWithAction(string serviceNameWithAction)
        {
            return BizNameWithActionRegex.IsMatch(serviceNameWithAction);
        }
